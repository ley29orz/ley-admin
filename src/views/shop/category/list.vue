<template>
	<div class="bg-white px-3" style="margin: -20px;margin-top: -1rem;margin-bottom: 0!important;">
		...
		default-expand-all :expand-on-click-node="false" draggable @node-drop="nodeDrop" @node-drag-end="nodeDragEnd">
	...
	export default {
		...
		methods: {
		  ...
		  showOrHide(data){
			 ...
			 this.axios.post('/admin/category/'+data.id+'/update_status',{ status },{
			 	token:true
			 }).then(res=>{
			 	data.status = status
				this.layout.hideLoading()
